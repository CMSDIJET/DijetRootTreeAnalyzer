...
void PlotSigmaBiasVsMass(double alpha_true, int function, int signal){
...
sprintf(input_txt_name_W0p0043, "output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha%s/bias_studies/SigmaBiasWithError_alpha%s_Gen%s_%s_W-0p0043.txt", alpha_true_name, alpha_true_name, function_name, signal_name);
sprintf(input_txt_name_W0p015, "output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha%s/bias_studies/SigmaBiasWithError_alpha%s_Gen%s_%s_W-0p015.txt", alpha_true_name, alpha_true_name, function_name, signal_name);
sprintf(input_txt_name_W0p05, "output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha%s/bias_studies/SigmaBiasWithError_alpha%s_Gen%s_%s_W-0p05.txt", alpha_true_name, alpha_true_name, function_name, signal_name);
sprintf(input_txt_name_W0p1, "output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha%s/bias_studies/SigmaBiasWithError_alpha%s_Gen%s_%s_W-0p1.txt", alpha_true_name, alpha_true_name, function_name, signal_name);
...
double mass_W0p0043[n], sigma_bias_W0p0043[n], sigma_bias_err_W0p0043[n];
double mass_W0p015[n], sigma_bias_W0p015[n], sigma_bias_err_W0p015[n];
double mass_W0p05[n], sigma_bias_W0p05[n], sigma_bias_err_W0p05[n];
double mass_W0p1[n], sigma_bias_W0p1[n], sigma_bias_err_W0p1[n];

for (int i=0; i<n; i++)
{
        infile_W0p0043 >> mass_W0p0043[i] >> sigma_bias_W0p0043[i] >> sigma_bias_err_W0p0043[i];
        infile_W0p015 >> mass_W0p015[i] >> sigma_bias_W0p015[i] >> sigma_bias_err_W0p015[i];
        infile_W0p05 >> mass_W0p05[i] >> sigma_bias_W0p05[i] >> sigma_bias_err_W0p05[i];
        infile_W0p1 >> mass_W0p1[i] >> sigma_bias_W0p1[i] >> sigma_bias_err_W0p1[i];
}
...
TGraphErrors *g_W0p0043 = new TGraphErrors(n, mass_W0p0043, sigma_bias_W0p0043, nullptr, sigma_bias_err_W0p0043);
TGraphErrors *g_W0p015 = new TGraphErrors(n, mass_W0p015, sigma_bias_W0p015, nullptr, sigma_bias_err_W0p015);
TGraphErrors *g_W0p05 = new TGraphErrors(n, mass_W0p05, sigma_bias_W0p05, nullptr, sigma_bias_err_W0p05);
TGraphErrors *g_W0p1 = new TGraphErrors(n, mass_W0p1, sigma_bias_W0p1, nullptr, sigma_bias_err_W0p1);
...
TLine *line1 = new TLine(1.5, 1, 10.5, 1);
...
sprintf(cname1,"output/Wide_Resonances_Run2_Final/plots/bias_studies/SigmaBiasVsWidth_alpha%s_Gen%s_%s_FitEnvelope.png", alpha_true_name, function_name, signal_name);
sprintf(cname2,"output/Wide_Resonances_Run2_Final/plots/bias_studies/SigmaBiasVsWidth_alpha%s_Gen%s_%s_FitEnvelope.pdf", alpha_true_name, function_name, signal_name);
