...
void Plot_Bkg_Fits_WithSignals(){
...
double sig_low_narrow_obs_limit = 0.00726744186*1.; //0.00259232 0.00645185 0.00923046 0.0128079 0.019948 0.042569 0.154751 0.527643 0.135375 0.0454604 0.0221066 0.0127674 0.00829717
...
double sig_low_wide_obs_limit = 0.00726744186*1.; //0.00272576 0.00759682 0.0117517 0.0204664 0.0360349 0.0860028 0.24281 0.35949 0.143907 0.0487569 0.0222529 0.0115559 0.0066486
...
TFile *f_sig_low_narrow = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/signals_13bins/alpha0p25/nominal/ResonanceShapes_Suu2200_Chi550_SR_noslices.root");
...
TFile *f_sig_low_wide = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p25/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-2200_chi-550_alphagt0p1.root");
...
TLegend *leg3 = new TLegend(0.5,0.88,0.9,0.93);
leg3->AddEntry((TObject*)0,  "Pulls of ModDijet-5p fit","");
...
c1->SaveAs("output/Wide_Resonances_Run2_Final/plots/bkg_fits/BkgFitsWithSignals_alphagt0p1.png");
c1->SaveAs("output/Wide_Resonances_Run2_Final/plots/bkg_fits/BkgFitsWithSignals_alphagt0p1.pdf");
