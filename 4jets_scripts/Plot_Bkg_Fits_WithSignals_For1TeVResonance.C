...
void Plot_Bkg_Fits_WithSignals_For1TeVResonance(){
...
double sig_high_narrow_obs_limit = 2.18023256e-05*1.; //0.0035386 0.00535179 0.00777911 0.0107328 0.0152658 0.0308533 0.134966 0.527608 0.141253 0.0511199 0.0305021 0.0226352 0.0183946
double sig_high_wide_obs_limit = 2.18023256e-05*1.; //0.00535932 0.00876979 0.0107998 0.0157531 0.020138 0.0315063 0.0777101 0.184978 0.177426 0.148437 0.127 0.0969549 0.0951685





double sig_low_narrow_obs_limit = 0.000726744*1.; //0.00276456 0.00517059 0.00742522 0.00956053 0.0116761 0.0157525 0.0287374 0.0519198 0.172189 0.521771 0.120814 0.0338415 0.018378 
double sig_low_wide_obs_limit = 0.000726744*1.; //0.00265078 0.00547306 0.00742521 0.0102742 0.0162088 0.0249265  0.042666 0.0856481 0.202656 0.307657 0.176142 0.0771381 0.0411337

	
//Fetch data, MC and fits		
TFile *f_data = new TFile("Fitting/HISTOS_4J_AlldataRun2_SR_alphagt0p1.root");
TFile *f_Fit_atlas = new TFile("Fitting/DijetFitResult_PFDijet2017_4J_alphagt0p1_atlas.root");
TFile *f_Fit_dijet = new TFile("Fitting/DijetFitResult_PFDijet2017_4J_alphagt0p1_dijet.root");
TFile *f_Fit_moddijet = new TFile("Fitting/DijetFitResult_PFDijet2017_4J_alphagt0p1_moddijet.root");
TFile *f_MC = new TFile("Fitting/QCD2017_Standardcuts_M4Jgt1p5_nobreak_alphagt0p1.root");
...
TFile *f_sig_low_narrow = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/signals_13bins/alpha0p29/nominal/ResonanceShapes_Suu3600_Chi1044_SR_noslices.root");
...
TFile *f_sig_middle_narrow = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/signals_13bins/alpha0p25/nominal/ResonanceShapes_Suu5000_Chi1250_SR_noslices.root");
...
TFile *f_sig_high_narrow = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/signals_13bins/alpha0p25/nominal/ResonanceShapes_Suu8600_Chi2150_SR_noslices.root");
...
TFile *f_sig_low_wide = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p29/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-3600_chi-1044_alphagt0p1.root");
TH1D *h_sig_low_wide  = (TH1D*)(f_sig_low_wide->Get("h_FourjetMass"));   
h_sig_low_wide->Scale(sig_low_wide_obs_limit*lumi);  

TFile *f_sig_middle_wide = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p25/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-5000_chi-1250_alphagt0p1.root");
TH1D *h_sig_middle_wide  = (TH1D*)(f_sig_middle_wide->Get("h_FourjetMass"));   
h_sig_middle_wide->Scale(sig_middle_wide_obs_limit*lumi); 

TFile *f_sig_high_wide = new TFile("/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p25/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-8600_chi-2150_alphagt0p1.root");
...
Standard_Fit_atlas->GetYaxis()->SetRangeUser(0.0000000015,1000000.);
...
Standard_Fit_dijet->GetYaxis()->SetRangeUser(0.0000000015,1000000.);
...
Standard_Fit_moddijet->GetYaxis()->SetRangeUser(0.0000000015,1000000.);

h_MC->SetLineColor(5);
h_MC->SetMarkerColor(5);
h_MC->GetXaxis()->SetRangeUser(startit,endit);
h_MC->GetYaxis()->SetRangeUser(0.0000000015,100000.);
...
TPaveText *pave3 = new TPaveText(0.67,0.39,0.91,0.54,"NDC");
pave3->AddText("M_{#chi} / M_{S} = 0.29");
pave3->AddText("#alpha > 0.10");
...
TLegend *leg2 = new TLegend(0.5,0.57,0.75,0.92);
...
leg2->AddEntry(h_sig_low_narrow,"#splitline{M_{S} = 3.6 TeV, #Gamma / M_{S} = 0.43 %}{(#bf{100%} of signal - inclusive case)}","l");
leg2->AddEntry(h_sig_low_wide,"#splitline{M_{S} = 3.6 TeV, #Gamma / M_{S} = 10 %}{(#bf{100%} of signal - inclusive case)}","l");
...
TLegend *leg3 = new TLegend(0.55,0.88,0.75,0.93);
...
c1->SaveAs("output/Wide_Resonances_Run2_Final/plots/bkg_fits/BkgFitsWithSignals_For1TeVResonance_alphagt0p1.png");
c1->SaveAs("output/Wide_Resonances_Run2_Final/plots/bkg_fits/BkgFitsWithSignals_For1TeVResonance_alphagt0p1.pdf");
