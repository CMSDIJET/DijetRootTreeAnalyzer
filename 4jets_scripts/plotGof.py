...
if args.statistic in ["AD","KS"]:
    ...
    plot.DrawCMSLogo(pads[0], 'CMS', args.cms_sub, 10, 0.05, 0.035, 1.2, '', 0.8)
    plot.DrawTitle(pads[0], args.title_right, 3)
    plot.DrawTitle(pads[0], args.title_left, 1)


    textlabel = ROOT.TPaveText(0.82, 0.88, 0.92, 0.92, "NDC")
    textlabel.SetBorderSize(   0 )
    textlabel.SetFillStyle (   0 )
    textlabel.SetTextAlign (  32 )
    textlabel.SetTextSize  (0.04 )
    ...
    pvalue = ROOT.TPaveText(0.82, 0.83, 0.92, 0.87, "NDC")
    pvalue.SetBorderSize(   0 )
    pvalue.SetFillStyle (   0 )
    pvalue.SetTextAlign (  32 )
    pvalue.SetTextSize  (0.04 )
    ...
    if args.legend is not None:   
        #plot.DrawTitle(pads[0], args.legend, 2, -2.8)
        legend_pave = ROOT.TPaveText(0.82, 0.65, 0.92, 0.73, "NDC")
        legend_pave.SetBorderSize(   0 )
        legend_pave.SetFillStyle (   0 )
        legend_pave.SetTextAlign (  32 )
        legend_pave.SetTextSize  (0.04 )
        legend_pave.SetTextColor (   1 )
        legend_pave.SetTextFont  (  42 )
        legend_pave.AddText(args.legend)
        legend_pave.Draw()
