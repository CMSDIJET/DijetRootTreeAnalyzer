...
widths=('0p0043' '0p015' '0p05')
Suu_masses=(2000)
alpha_true_values=(0.27)
...
do
    ...
    do
   	...
   	do
	    ...
	    #combine -M GoodnessOfFit --algo=saturated output/Wide_Resonances_Run2_Final/datacards_alpha0p"$alphap"_refxsec0p01pb/workspace_combined_W-"$width"_"$Suu"_"$Chi".root -n _SignalPlusBkgFit_W-"$width"_"$Suu"_"$Chi"_DATA
