    ...
    do
   	...
   	do
   	    ...
   	    #echo $Suu 
            ...
            #cd output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha0p"$alphap"/HN_limits/crab_final_hybridNew_limits_13_slices_envelope_3_func_alpha0p"$alphap"_W-"$width"_"$Suu"_"$Chi"/results/
            cd output/Wide_Resonances_Run2_Final/combine_rootfiles_alpha0p"$alphap"/HN_significances/crab_final_hybridNew_significances_13_slices_envelope_3_func_alpha0p"$alphap"_W-"$width"_"$Suu"_"$Chi"/results/
            ls | wc -l
            #echo ""
