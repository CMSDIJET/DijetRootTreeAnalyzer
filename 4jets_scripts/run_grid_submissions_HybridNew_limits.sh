...
## Grid submissions for *final* limits with HybridNew for Suu masses of 4.5 TeV and above (up to 10 TeV)
## July 2024
    ...
    do
   	...
   	do
   	    ...
   	    echo $Chi
            ...
            echo "combineTool.py -d output/Wide_Resonances_Run2_Final/datacards_alpha0p"$alphap"_refxsec0p01pb/workspace_combined_W-"$width"_"$Suu"_"$Chi".root -M HybridNew -v -1  --LHCmode LHC-limits --clsAcc 0 -T 200 -i 10 -s 10148:10152:1 --singlePoint 0.0:$max:$stepsize --rMax "$rmax" --saveToys --saveHybridResult -m 125 --job-mode crab3 --task-name final_hybridNew_limits_13_slices_Envelope_3_func_alpha0p"$alphap"_W-"$width"_"$Suu"_"$Chi" --custom-crab custom_crab.py"
            
            combineTool.py -d output/Wide_Resonances_Run2_Final/datacards_alpha0p"$alphap"_refxsec0p01pb/workspace_combined_W-"$width"_"$Suu"_"$Chi".root -M HybridNew -v -1  --LHCmode LHC-limits --clsAcc 0 -T 200 -i 10 -s 10148:10152:1 --singlePoint 0.0:$max:$stepsize --rMax "$rmax" --saveToys --saveHybridResult -m 125 --job-mode crab3 --task-name final_hybridNew_limits_13_slices_envelope_3_func_alpha0p"$alphap"_W-"$width"_"$Suu"_"$Chi" --custom-crab custom_crab.py
