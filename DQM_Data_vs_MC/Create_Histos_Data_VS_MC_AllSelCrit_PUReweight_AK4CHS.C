...
void Create_Histos_Data_VS_MC_AllSelCrit_PUReweight_AK4CHS(){

TFile *fpu = new TFile("RunsCD_7p3fb-1/PUReweight_RunsCD_PUPPI.root","READ");
...
TH1D *h_chargedMult_phigt0_data, *h_chargedMult_philt0_data;
TH1D *h_chargedMult_phigt0_mc, *h_chargedMult_philt0_mc;
...
h_pT_data = new TH1D("h_pT_data","",50,0,4000);
h_pT_mc = new TH1D("h_pT_mc","",50,0,4000);

h_pTj1_data = new TH1D("h_pTj1_data","",50,0,4000);
h_pTj2_data = new TH1D("h_pTj2_data","",50,0,4000);
h_pTj3_data = new TH1D("h_pTj3_data","",50,0,4000);
h_pTj4_data = new TH1D("h_pTj4_data","",50,0,4000);
h_pTj1_mc = new TH1D("h_pTj1_mc","",50,0,4000);
h_pTj2_mc = new TH1D("h_pTj2_mc","",50,0,4000);
h_pTj3_mc = new TH1D("h_pTj3_mc","",50,0,4000);
h_pTj4_mc = new TH1D("h_pTj4_mc","",50,0,4000);
...
h_chargedElectromFrac_data = new TH1D("h_chargedElectromFrac_data","",30,0,1.2);
h_chargedElectromFrac_mc = new TH1D("h_chargedElectromFrac_mc","",30,0,1.2);
h_chargedElectromFrac_j1_data = new TH1D("h_chargedElectromFrac_j1_data","",30,0,1.2);
h_chargedElectromFrac_j2_data = new TH1D("h_chargedElectromFrac_j2_data","",30,0,1.2);
h_chargedElectromFrac_j3_data = new TH1D("h_chargedElectromFrac_j3_data","",30,0,1.2);
h_chargedElectromFrac_j4_data = new TH1D("h_chargedElectromFrac_j4_data","",30,0,1.2);
...
h_chargedHadEnFrac_data = new TH1D("h_chargedHadEnFrac_data","",30,0,1.2);
h_chargedHadEnFrac_mc = new TH1D("h_chargedHadEnFrac_mc","",30,0,1.2);
h_chargedHadEnFrac_j1_data = new TH1D("h_chargedHadEnFrac_j1_data","",30,0,1.2);
h_chargedHadEnFrac_j2_data = new TH1D("h_chargedHadEnFrac_j2_data","",30,0,1.2);
h_chargedHadEnFrac_j3_data = new TH1D("h_chargedHadEnFrac_j3_data","",30,0,1.2);
h_chargedHadEnFrac_j4_data = new TH1D("h_chargedHadEnFrac_j4_data","",30,0,1.2);
...
h_neutrElectromFrac_data = new TH1D("h_neutrElectromFrac_data","",30,0,1.2);
h_neutrElectromFrac_mc = new TH1D("h_neutrElectromFrac_mc","",30,0,1.2);
h_neutrElectromFrac_j1_data = new TH1D("h_neutrElectromFrac_j1_data","",30,0,1.2);
h_neutrElectromFrac_j2_data = new TH1D("h_neutrElectromFrac_j2_data","",30,0,1.2);
h_neutrElectromFrac_j3_data = new TH1D("h_neutrElectromFrac_j3_data","",30,0,1.2);
h_neutrElectromFrac_j4_data = new TH1D("h_neutrElectromFrac_j4_data","",30,0,1.2);
...
h_neutrHadEnFrac_data = new TH1D("h_neutrHadEnFrac_data","",30,0,1.2);
h_neutrHadEnFrac_mc = new TH1D("h_neutrHadEnFrac_mc","",30,0,1.2);
h_neutrHadEnFrac_j1_data = new TH1D("h_neutrHadEnFrac_j1_data","",30,0,1.2);
h_neutrHadEnFrac_j2_data = new TH1D("h_neutrHadEnFrac_j2_data","",30,0,1.2);
h_neutrHadEnFrac_j3_data = new TH1D("h_neutrHadEnFrac_j3_data","",30,0,1.2);
h_neutrHadEnFrac_j4_data = new TH1D("h_neutrHadEnFrac_j4_data","",30,0,1.2);
...
h_photonEnFrac_data = new TH1D("h_photonEnFrac_data","",30,0,1.2);
h_photonEnFrac_mc = new TH1D("h_photonEnFrac_mc","",30,0,1.2);
h_photonEnFrac_j1_data = new TH1D("h_photonEnFrac_j1_data","",30,0,1.2);
h_photonEnFrac_j2_data = new TH1D("h_photonEnFrac_j2_data","",30,0,1.2);
h_photonEnFrac_j3_data = new TH1D("h_photonEnFrac_j3_data","",30,0,1.2);
h_photonEnFrac_j4_data = new TH1D("h_photonEnFrac_j4_data","",30,0,1.2);
...
h_muEnFrac_data = new TH1D("h_muEnFrac_data","",30,0,1.2);
h_muEnFrac_mc = new TH1D("h_muEnFrac_mc","",30,0,1.2);
h_muEnFrac_j1_data = new TH1D("h_muEnFrac_j1_data","",30,0,1.2);
h_muEnFrac_j2_data = new TH1D("h_muEnFrac_j2_data","",30,0,1.2);
h_muEnFrac_j3_data = new TH1D("h_muEnFrac_j3_data","",30,0,1.2);
h_muEnFrac_j4_data = new TH1D("h_muEnFrac_j4_data","",30,0,1.2);
...
h_chargedMult_data = new TH1D("h_chargedMult_data","",35,0,70);
h_chargedMult_mc = new TH1D("h_chargedMult_mc","",35,0,70);
h_chargedMult_j1_data = new TH1D("h_chargedMult_j1_data","",35,0,70);
h_chargedMult_j2_data = new TH1D("h_chargedMult_j2_data","",35,0,70);
h_chargedMult_j3_data = new TH1D("h_chargedMult_j3_data","",35,0,70);
h_chargedMult_j4_data = new TH1D("h_chargedMult_j4_data","",35,0,70);
h_chargedMult_j1_mc = new TH1D("h_chargedMult_j1_mc","",35,0,70);
h_chargedMult_j2_mc = new TH1D("h_chargedMult_j2_mc","",35,0,70);
h_chargedMult_j3_mc = new TH1D("h_chargedMult_j3_mc","",35,0,70);
h_chargedMult_j4_mc = new TH1D("h_chargedMult_j4_mc","",35,0,70);

h_neutrMult_data = new TH1D("h_neutrMult_data","",35,0,70);
h_neutrMult_mc = new TH1D("h_neutrMult_mc","",35,0,70);
h_neutrMult_j1_data = new TH1D("h_neutrMult_j1_data","",35,0,70);
h_neutrMult_j2_data = new TH1D("h_neutrMult_j2_data","",35,0,70);
h_neutrMult_j3_data = new TH1D("h_neutrMult_j3_data","",35,0,70);
h_neutrMult_j4_data = new TH1D("h_neutrMult_j4_data","",35,0,70);
h_neutrMult_j1_mc = new TH1D("h_neutrMult_j1_mc","",35,0,70);
h_neutrMult_j2_mc = new TH1D("h_neutrMult_j2_mc","",35,0,70);
h_neutrMult_j3_mc = new TH1D("h_neutrMult_j3_mc","",35,0,70);
h_neutrMult_j4_mc = new TH1D("h_neutrMult_j4_mc","",35,0,70);

h_photonMult_data = new TH1D("h_photonMult_data","",35,0,70);
h_photonMult_mc = new TH1D("h_photonMult_mc","",35,0,70);
h_photonMult_j1_data = new TH1D("h_photonMult_j1_data","",35,0,70);
h_photonMult_j2_data = new TH1D("h_photonMult_j2_data","",35,0,70);
h_photonMult_j3_data = new TH1D("h_photonMult_j3_data","",35,0,70);
h_photonMult_j4_data = new TH1D("h_photonMult_j4_data","",35,0,70);
h_photonMult_j1_mc = new TH1D("h_photonMult_j1_mc","",35,0,70);
h_photonMult_j2_mc = new TH1D("h_photonMult_j2_mc","",35,0,70);
h_photonMult_j3_mc = new TH1D("h_photonMult_j3_mc","",35,0,70);
h_photonMult_j4_mc = new TH1D("h_photonMult_j4_mc","",35,0,70);

h_nVtx_data = new TH1D("h_nVtx_data","",70,0,70);
h_nVtx_mc = new TH1D("h_nVtx_mc","",70,0,70);

h_chargedMult_phigt0_data = new TH1D("h_chargedMult_phigt0_data","",35,0,70);
h_chargedMult_philt0_data = new TH1D("h_chargedMult_philt0_data","",35,0,70);
h_chargedMult_phigt0_mc = new TH1D("h_chargedMult_phigt0_mc","",35,0,70);
h_chargedMult_philt0_mc = new TH1D("h_chargedMult_philt0_mc","",35,0,70);
...
h_nVtx_mc->Sumw2();
h_chargedMult_phigt0_mc->Sumw2();
h_chargedMult_philt0_mc->Sumw2();
h_etaphi_mc->Sumw2();
...
tree_data->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/data/promptReco/Winter22Run3_V1_JECs_MCtruthOnly_withRun2JetID/JetHT__Run2022C-PromptReco-v1__AK4CHS_reduced_skim.root");
tree_data->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/data/promptReco/Winter22Run3_V1_JECs_MCtruthOnly_withRun2JetID/JetMET__Run2022C-PromptReco-v1__AK4CHS_reduced_skim.root");
tree_data->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/data/promptReco/Winter22Run3_V1_JECs_MCtruthOnly_withRun2JetID/JetMET__Run2022D-PromptReco-v1__AK4CHS_reduced_skim.root");
tree_data->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/data/promptReco/Winter22Run3_V1_JECs_MCtruthOnly_withRun2JetID/JetMET__Run2022D-PromptReco-v2__AK4CHS_reduced_skim.root");

tree_data->SetBranchAddress("run",&run);
tree_data->SetBranchAddress("lumi",&lumi);
tree_data->SetBranchAddress("event",&event);
tree_data->SetBranchAddress("FourjetMassAK4CHS",&FourjetMass);
tree_data->SetBranchAddress("MaverageAK4CHS",&Maverage);
tree_data->SetBranchAddress("Dijet_MassAK4CHS_1",&Dijet_Mass_1);
tree_data->SetBranchAddress("Dijet_MassAK4CHS_2",&Dijet_Mass_2);
tree_data->SetBranchAddress("MasymmetryAK4CHS",&Masymmetry);
tree_data->SetBranchAddress("DeltaEtaJJAK4CHS",&DeltaEtaJJ);
tree_data->SetBranchAddress("DeltaPhiJJAK4CHS",&DeltaPhiJJ);
tree_data->SetBranchAddress("DeltaRAK4CHS_First",&DeltaR_First);
tree_data->SetBranchAddress("DeltaRAK4CHS_Second",&DeltaR_Second);
tree_data->SetBranchAddress("METoverHTAK4CHS",&METoverHT);
tree_data->SetBranchAddress("pTAK4CHS_j1",&pTj1);
tree_data->SetBranchAddress("pTAK4CHS_j2",&pTj2);
tree_data->SetBranchAddress("pTAK4CHS_j3",&pTj3);
tree_data->SetBranchAddress("pTAK4CHS_j4",&pTj4);
tree_data->SetBranchAddress("etaAK4CHS_j1",&etaj1);
tree_data->SetBranchAddress("etaAK4CHS_j2",&etaj2);
tree_data->SetBranchAddress("etaAK4CHS_j3",&etaj3);
tree_data->SetBranchAddress("etaAK4CHS_j4",&etaj4);
tree_data->SetBranchAddress("phiAK4CHS_j1",&phij1);
tree_data->SetBranchAddress("phiAK4CHS_j2",&phij2);
tree_data->SetBranchAddress("phiAK4CHS_j3",&phij3);
tree_data->SetBranchAddress("phiAK4CHS_j4",&phij4);
tree_data->SetBranchAddress("chargedElectromFracAK4CHS_j1",&chargedElectromFrac_j1);
tree_data->SetBranchAddress("chargedElectromFracAK4CHS_j2",&chargedElectromFrac_j2);
tree_data->SetBranchAddress("chargedElectromFracAK4CHS_j3",&chargedElectromFrac_j3);
tree_data->SetBranchAddress("chargedElectromFracAK4CHS_j4",&chargedElectromFrac_j4);
tree_data->SetBranchAddress("chargedHadEnFracAK4CHS_j1",&chargedHadEnFrac_j1);
tree_data->SetBranchAddress("chargedHadEnFracAK4CHS_j2",&chargedHadEnFrac_j2);
tree_data->SetBranchAddress("chargedHadEnFracAK4CHS_j3",&chargedHadEnFrac_j3);
tree_data->SetBranchAddress("chargedHadEnFracAK4CHS_j4",&chargedHadEnFrac_j4);
tree_data->SetBranchAddress("neutrElectromFracAK4CHS_j1",&neutrElectromFrac_j1);
tree_data->SetBranchAddress("neutrElectromFracAK4CHS_j2",&neutrElectromFrac_j2);
tree_data->SetBranchAddress("neutrElectromFracAK4CHS_j3",&neutrElectromFrac_j3);
tree_data->SetBranchAddress("neutrElectromFracAK4CHS_j4",&neutrElectromFrac_j4);
tree_data->SetBranchAddress("neutrHadEnFracAK4CHS_j1",&neutrHadEnFrac_j1);
tree_data->SetBranchAddress("neutrHadEnFracAK4CHS_j2",&neutrHadEnFrac_j2);
tree_data->SetBranchAddress("neutrHadEnFracAK4CHS_j3",&neutrHadEnFrac_j3);
tree_data->SetBranchAddress("neutrHadEnFracAK4CHS_j4",&neutrHadEnFrac_j4);
tree_data->SetBranchAddress("photonEnFracAK4CHS_j1",&photonEnFrac_j1);
tree_data->SetBranchAddress("photonEnFracAK4CHS_j2",&photonEnFrac_j2);
tree_data->SetBranchAddress("photonEnFracAK4CHS_j3",&photonEnFrac_j3);
tree_data->SetBranchAddress("photonEnFracAK4CHS_j4",&photonEnFrac_j4);
tree_data->SetBranchAddress("muEnFractAK4CHS_j1",&muEnFrac_j1);
tree_data->SetBranchAddress("muEnFractAK4CHS_j2",&muEnFrac_j2);
tree_data->SetBranchAddress("muEnFractAK4CHS_j3",&muEnFrac_j3);
tree_data->SetBranchAddress("muEnFractAK4CHS_j4",&muEnFrac_j4);
tree_data->SetBranchAddress("chargedMultAK4CHS_j1",&chargedMult_j1);
tree_data->SetBranchAddress("chargedMultAK4CHS_j2",&chargedMult_j2);
tree_data->SetBranchAddress("chargedMultAK4CHS_j3",&chargedMult_j3);
tree_data->SetBranchAddress("chargedMultAK4CHS_j4",&chargedMult_j4);
tree_data->SetBranchAddress("neutrMultAK4CHS_j1",&neutrMult_j1);
tree_data->SetBranchAddress("neutrMultAK4CHS_j2",&neutrMult_j2);
tree_data->SetBranchAddress("neutrMultAK4CHS_j3",&neutrMult_j3);
tree_data->SetBranchAddress("neutrMultAK4CHS_j4",&neutrMult_j4);
tree_data->SetBranchAddress("photonMultAK4CHS_j1",&photonMult_j1);
tree_data->SetBranchAddress("photonMultAK4CHS_j2",&photonMult_j2);
tree_data->SetBranchAddress("photonMultAK4CHS_j3",&photonMult_j3);
tree_data->SetBranchAddress("photonMultAK4CHS_j4",&photonMult_j4);
...
//for (int i=0; i<100000; i++){
	...
	if(FourjetMass>1607 && Masymmetry<0.1 && DeltaEtaJJ<1.1 && DeltaR_First<2.0 && DeltaR_Second<2.0 && alpha>0.1)
	{
		...
		if(phij1>0) h_chargedMult_phigt0_data->Fill(chargedMult_j1);
		if(phij2>0) h_chargedMult_phigt0_data->Fill(chargedMult_j2);
		if(phij3>0) h_chargedMult_phigt0_data->Fill(chargedMult_j3);
		if(phij4>0) h_chargedMult_phigt0_data->Fill(chargedMult_j4);
		if(phij1<0) h_chargedMult_philt0_data->Fill(chargedMult_j1);
		if(phij2<0) h_chargedMult_philt0_data->Fill(chargedMult_j2);
		if(phij3<0) h_chargedMult_philt0_data->Fill(chargedMult_j3);
		if(phij4<0) h_chargedMult_philt0_data->Fill(chargedMult_j4);
...
tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/QCDFlat_Winter22/Winter22Run3_V1_JECs_withRun2JetID/QCDFlatMC_Winter22_AK4CHS_reduced_skim.root");
...
//for (int i=0; i<100000; i++){
	...
	if(FourjetMass>1607 && Masymmetry<0.1 && DeltaEtaJJ<1.1 && DeltaR_First<2.0 && DeltaR_Second<2.0 && alpha>0.1 && event!=13640402 && event!=14664628)
	{
		...
		if(phij1>0) h_chargedMult_phigt0_mc->Fill(chargedMult_j1, weight);
		if(phij2>0) h_chargedMult_phigt0_mc->Fill(chargedMult_j2, weight);
		if(phij3>0) h_chargedMult_phigt0_mc->Fill(chargedMult_j3, weight);
		if(phij4>0) h_chargedMult_phigt0_mc->Fill(chargedMult_j4, weight);
		if(phij1<0) h_chargedMult_philt0_mc->Fill(chargedMult_j1, weight);
		if(phij2<0) h_chargedMult_philt0_mc->Fill(chargedMult_j2, weight);
		if(phij3<0) h_chargedMult_philt0_mc->Fill(chargedMult_j3, weight);
		if(phij4<0) h_chargedMult_philt0_mc->Fill(chargedMult_j4, weight);
...
TFile *fout = new TFile("RunsCD_7p3fb-1/Histos_DataRuns2022CD_VS_QCDFlatMC_AllSelCrit_PUReweight_AK4CHS_MCtruthOnly.root","RECREATE");
fout->cd();
...
h_nVtx_data->Write();
h_chargedMult_phigt0_data->Write();
h_chargedMult_philt0_data->Write();
h_etaphi_data->Write();
...
h_nVtx_mc->Write();
h_chargedMult_phigt0_mc->Write();
h_chargedMult_philt0_mc->Write();
h_etaphi_mc->Write();
