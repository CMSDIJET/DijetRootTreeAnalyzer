...
void Create_Histos_MC_AK4PUPPI(){

TFile *fpu = new TFile("mc_histos/Run3Summer22_PUReweightWith2023Data.root","READ");
//TFile *fpu = new TFile("mc_histos/Run3Summer22EE_PUReweightWith2023Data.root","READ");
...
TH1D *h_phi_eta1p479to2p172_mc; 
TH1D *h_phi_NOTeta1p479to2p172_mc; 
...
h_FourjetMass_EE_area_mc = new TH1D("h_FourjetMass_EE_area_mc","",103,massBoundaries);

h_FourjetMass_NOT_EE_area_mc = new TH1D("h_FourjetMass_NOT_EE_area_mc","",103,massBoundaries);
...
h_etaphi_mc = new TH2D("h_etaphi_mc","",30,-3,3,32,-3.2,3.2);

h_phi_eta1p479to2p172_mc = new TH1D("h_phi_eta1p479to2p172_mc","",32,-3.2,3.2);
h_phi_NOTeta1p479to2p172_mc = new TH1D("h_phi_NOTeta1p479to2p172_mc","",32,-3.2,3.2); 

h_FourjetMass_mc->Sumw2();
h_FourjetMass_EE_area_mc->Sumw2();
h_FourjetMass_NOT_EE_area_mc->Sumw2();
h_Maverage_mc->Sumw2();
...
h_nVtx_mc->Sumw2();
h_etaphi_mc->Sumw2();
h_phi_eta1p479to2p172_mc->Sumw2();
h_phi_NOTeta1p479to2p172_mc->Sumw2();

double run, lumi, event, weight, nVtx, w, passFilter_BadPFMuon, passFilter_EcalDeadCellTriggerPrimitive, passFilter_eeBadSc, passFilter_globalSuperTightHalo2016, passFilter_goodVertices;
...
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-50to80_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-80to120_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-120to170_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-170to300_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-300to470_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-470to600_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-600to800_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-800to1000_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-1000to1400_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-1400to1800_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-1800to2400_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-2400to3200_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");
//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/QCD_PT-3200toInf_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_reduced_skim.root");

//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/Stitched_QCD_PT-120toInf_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4PUPPI_35084pb-1_reduced_skim.root");

tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22EE/Summer22EERun3_V1_JECs/Stitched_QCD_PT-120toInf_TuneCP5_13p6TeV_pythia8__Run3Summer22EEMiniAODv3-124X_mcRun3_2022_realistic_postEE_v1_ext1-v2__AK4PUPPI_35084pb-1_reduced_skim.root");
...
//for (int i=0; i<100000; i++){
	...
	if(FourjetMass>1607 && Masymmetry<0.1 && DeltaEtaJJ<1.1 && DeltaR_First<2.0 && DeltaR_Second<2.0 && alpha>0.1)
	{
		...
		h_FourjetMass_1GeV_mc->Fill(FourjetMass, weight);
		...
		h_etaphi_mc->Fill(etaj1, phij1, weight);
		h_etaphi_mc->Fill(etaj2, phij2, weight);
		h_etaphi_mc->Fill(etaj3, phij3, weight);
		h_etaphi_mc->Fill(etaj4, phij4, weight);

		if(etaj1>1.479 && etaj1<2.172) h_phi_eta1p479to2p172_mc->Fill(phij1, weight);
		if(etaj2>1.479 && etaj2<2.172) h_phi_eta1p479to2p172_mc->Fill(phij2, weight);
		if(etaj3>1.479 && etaj3<2.172) h_phi_eta1p479to2p172_mc->Fill(phij3, weight);
		if(etaj4>1.479 && etaj4<2.172) h_phi_eta1p479to2p172_mc->Fill(phij4, weight);

		if(!(etaj1>1.479 && etaj1<2.172)) h_phi_NOTeta1p479to2p172_mc->Fill(phij1, weight);
		if(!(etaj2>1.479 && etaj2<2.172)) h_phi_NOTeta1p479to2p172_mc->Fill(phij2, weight);
		if(!(etaj3>1.479 && etaj3<2.172)) h_phi_NOTeta1p479to2p172_mc->Fill(phij3, weight);
		if(!(etaj4>1.479 && etaj4<2.172)) h_phi_NOTeta1p479to2p172_mc->Fill(phij4, weight);


		if( (etaj1>1.479 && etaj1<2.172 && phij1>1.8326 && phij1<2.70526) || (etaj2>1.479 && etaj2<2.172 && phij2>1.8326 && phij2<2.70526) || (etaj3>1.479 && etaj3<2.172 && phij3>1.8326 && phij3<2.70526) || (etaj4>1.479 && etaj4<2.172 && phij4>1.8326 && phij4<2.70526) )
		{ 
			h_FourjetMass_EE_area_mc->Fill(FourjetMass, weight);
		}
		else
		{
			h_FourjetMass_NOT_EE_area_mc->Fill(FourjetMass, weight);
		}
...
//TFile *fout = new TFile("mc_histos/Histos_Run3Summer22_Stitched_QCD_PT-120toInf_35084pb-1_new.root","RECREATE");
TFile *fout = new TFile("mc_histos/Histos_Run3Summer22EE_Stitched_QCD_PT-120toInf_35084pb-1_new.root","RECREATE");
fout->cd();
...
h_nVtx_mc->Write();
h_etaphi_mc->Write();
h_phi_eta1p479to2p172_mc->Write();
h_phi_NOTeta1p479to2p172_mc->Write();
h_FourjetMass_EE_area_mc->Write();
h_FourjetMass_NOT_EE_area_mc->Write();
