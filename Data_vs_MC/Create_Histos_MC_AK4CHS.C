...
double run, lumi, event, weight, nVtx, w, passFilter_BadPFMuon, passFilter_BadPFMuonDz, passFilter_EcalDeadCellTriggerPrimitive, passFilter_eeBadSc, passFilter_globalSuperTightHalo2016, passFilter_goodVertices, passFilter_ecalBadCalib, passFilter_hfNoisyHits;
...
tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22/Summer22Run3_V1_JECs/Stitched_QCD_PT-120toInf_TuneCP5_13p6TeV_pythia8__Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12_ext1-v2__AK4CHS_35084pb-1_reduced_skim.root");

//tree_mc->Add("root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run3/reduced_trees/QCDMC/Run3Summer22EE/Summer22EERun3_V1_JECs/Stitched_QCD_PT-120toInf_TuneCP5_13p6TeV_pythia8__Run3Summer22EEMiniAODv3-124X_mcRun3_2022_realistic_postEE_v1_ext1-v2__AK4CHS_35084pb-1_reduced_skim.root");
...
tree_mc->SetBranchAddress("passFilter_BadPFMuonDz",&passFilter_BadPFMuonDz);
tree_mc->SetBranchAddress("passFilter_ecalBadCalib",&passFilter_ecalBadCalib);
tree_mc->SetBranchAddress("passFilter_hfNoisyHits",&passFilter_hfNoisyHits);
...
TFile *fout = new TFile("mc_histos/Histos_Run3Summer22_Stitched_QCD_PT-120toInf_35084pb-1_AK4CHS.root","RECREATE");
