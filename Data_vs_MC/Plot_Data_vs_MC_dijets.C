...
void Plot_Data_vs_MC_dijets(char jetAlgo[1024], char run[1024], char var[1024]){

char fname[1024];
sprintf(fname,"/afs/cern.ch/user/m/mkotsari/public/forIlias/Histos_DataRun2022BCDEF_VS_QCDFlatMC_Selection_Criteria_pT_lower_6p8_AK4PUPPI.root");

char xaxistitle[1024];
double xmin, xmax;

if(strcmp(var,"Dijet_Mass")==0) {sprintf(xaxistitle,"Dijet mass [GeV]");  xmin = 1607; xmax = 9067;}
if(strcmp(var,"pT")==0) {sprintf(xaxistitle,"p_{T} of the 2 wide jets [GeV]"); xmin=0; xmax=4000;}
...
//top right
if(strcmp(var,"Dijet_Mass")==0 || strcmp(var,"Maverage")==0 || strcmp(var,"pT")==0 || strcmp(var,"pTj1")==0 || strcmp(var,"pTj2")==0 || strcmp(var,"pTj3")==0 || strcmp(var,"pTj4")==0 || strcmp(var,"NHF")==0 || strcmp(var,"METoverHT")==0 || strcmp(var,"NM")==0) 
{
...
sprintf(cname_1,"PUReweighted_AllCuts_DataRun2022%s_VS_MC_%s_%s_EXOWS.png",run,jetAlgo,var);
sprintf(cname_2,"PUReweighted_AllCuts_DataRun2022%s_VS_MC_%s_%s_EXOWS.pdf",run,jetAlgo,var);
