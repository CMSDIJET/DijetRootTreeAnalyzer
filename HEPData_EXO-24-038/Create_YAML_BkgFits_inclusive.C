...
void Create_YAML_BkgFits_inclusive(){
...
double sig_narrow_norm_8p6 = 0.000047642*1.;
double sig_wide_norm_8p6 = 0.000063891*1.;

double sig_narrow_norm_3p6 = 0.001337810*1.;
double sig_wide_norm_3p6 = 0.002232955*1.;
...
sprintf(fname_data, "inputs/HISTOS_4J_AlldataRun2_SR_alphagt0p1.root");
sprintf(fname_Fit_atlas, "inputs/DijetFitResult_PFDijetRun2_4J_alphagt0p1_PowExp.root");
sprintf(fname_Fit_dijet, "inputs/DijetFitResult_PFDijetRun2_4J_alphagt0p1_Dijet.root");
sprintf(fname_Fit_moddijet, "inputs/DijetFitResult_PFDijetRun2_4J_alphagt0p1_ModDijet.root");
...
sprintf(fname_sig_narrow_8p6, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p25/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p015_S-8600_chi-2150_alphagt0p1.root");
...
sprintf(fname_sig_wide_8p6, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p25/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-8600_chi-2150_alphagt0p1.root");
...
sprintf(fname_sig_narrow_3p6, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p29/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p015_S-3600_chi-1044_alphagt0p1.root");
...
sprintf(fname_sig_wide_3p6, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Wide_Resonance_Search/signal_histos/alpha0p29/ResonanceShapes_NOMINAL_Suu-Diquark_W-0p1_S-3600_chi-1044_alphagt0p1.root");
...
Standard_Fit_atlas->GetYaxis()->SetRangeUser(0.000000015,90000.);
...
Standard_Fit_dijet->GetYaxis()->SetRangeUser(0.000000015,90000.);
...
Standard_Fit_moddijet->GetYaxis()->SetRangeUser(0.000000015,90000.);
...
char outF_name[1024];
sprintf(outF_name, "outputs/Figure_007_BkgFitsWithSignals_alphagt0p1.yaml");
