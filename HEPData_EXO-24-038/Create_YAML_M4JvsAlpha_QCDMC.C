...
void Create_YAML_M4JvsAlpha_QCDMC()
{

    TFile *f = new TFile("inputs/M4JvsAlpha_QCDMC.root", "READ");
    TH2D* h = (TH2D*)f->Get("h_M4J_vs_alpha");
    
    char yamlFileName[1024];
    sprintf(yamlFileName, "outputs/Figure_002-d_M4JvsAlpha_QCDMC.yaml");
