...
void Plot_DNLL_forSupplementary_lowmass(double width, double alpha_true, double Suu){
...
auto frame = c->DrawFrame(-0.06,1158281,0.32,1158318.);
...
sprintf(siglegname1,"M_{S} = %.1f TeV, M_{#chi} = %.1f TeV", Suu/1000., (Suu*alpha_true)/1000.);
...
TPaveText *sigleg = new TPaveText(0.25,0.72,0.45,0.87,"NDC");
...
TLegend *leg = new TLegend(0.69,0.68,0.89,0.88,"");
leg->SetBorderSize(0);
