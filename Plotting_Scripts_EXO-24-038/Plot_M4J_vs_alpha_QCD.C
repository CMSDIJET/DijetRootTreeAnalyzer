...
TPaveText *paveCMS3 = new TPaveText(0.16,0.83,0.31,0.88,"NDC");
...
sprintf(f_name, "files/M4JvsAlpha_QCDMC.root");
...
TH2D *h_M4J_vs_alpha = (TH2D*)(f->Get("h_M4J_vs_alpha"));
...
lat->DrawLatexNDC(0.165, 0.780, "#color[629]{0.4} #color[418]{(33)} QCD events");
lat->DrawLatexNDC(0.165, 0.735, "expected in the");
lat->DrawLatexNDC(0.165, 0.690, "68% contour for");
lat->DrawLatexNDC(0.165, 0.645, "#Gamma / M_{S} = #color[629]{1.5} #color[418]{(10)}%");


TPaveText *paveCMS4 = new TPaveText(0.535,0.52,0.77,0.88,"NDC");
...
char cname[1024];
sprintf(cname, "plots/Figure_002-d.pdf");
