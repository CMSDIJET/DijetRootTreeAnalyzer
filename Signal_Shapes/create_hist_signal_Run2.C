...
void create_hist_signal_Run2(int Suu, int Chi){
...
char fname[1024];
sprintf(fname,"root:://eoscms///eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/eirini/4jets/Signal/MC2017/newGeneratedSignals/MC2017_Suu_Diquark_S%d_chi%d_reduced_skim.root",Suu,Chi);
...
char foutname[1024];
sprintf(foutname,"rootfiles/ResonanceShapes_EOY2017_Suu_Diquark_S%d_chi%d.root",Suu,Chi);
