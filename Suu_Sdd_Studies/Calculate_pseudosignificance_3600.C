...
double Calculate_pseudosignificance_3600(double width, double alpha_true, double Suu){
...
if(Suu==7000) events_normal = 90;
if(Suu==8000) events_normal = 60;
if(Suu==8400) events_normal = 60;
if(Suu==8600) events_normal = 60;
if(Suu==9000) events_normal = 60;
if(Suu==10000) events_normal = 60;
...
TH1D *hSig = (TH1D*)fSig->Get("h_FourjetMass");


double weight_signal = (1.*events_normal)/5.;
