...
#include <string>
#include <sstream>
#include "Calculate_pseudosignificance.C"
using namespace std;

void calculate_product_of_sigma_BR_acc_eff_SddModel(double width, double alpha_true, double S) {
...
else
{
     if(S!=10000 && S!=11000) 
     {
         sprintf(fname, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/reduced_trees/Suu_Diquarks/RunIIFall17MiniAODv2/JEC_Fall17_17Nov2017_V6_MC_NOMINAL/MC2017_Suu_Diquark_S%.0f_chi%.0f_reduced_skim.root", S, S*alpha_true);
    ...
    {
        sprintf(fname, "/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/ilias/4jets_Run2/Narrow_Resonance_Search/reduced_trees/Suu_Diquarks/RunIISummer20UL18MiniAODv2/JEC_Summer20UL18_MC_NOMINAL/RunIISummer20UL18_Suu-Diquark_W-%s_S-%.0f_chi-%.0f__AK4CHS_reduced_skim.root", width_name, S, S*alpha_true);
...
gROOT->ProcessLine(".L Calculate_pseudosignificance.C");
double bin = Calculate_pseudosignificance(width, alpha_true, S); // Example args
