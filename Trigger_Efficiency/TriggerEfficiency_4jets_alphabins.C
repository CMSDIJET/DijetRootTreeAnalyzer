...
{  
   ...
   char txtname[1024];
   sprintf(txtname,"2022_PromptReco_new/textfiles/trig_2022_PromptReco_era%s_alpha%d.txt",era,alphabin);
   ...
   sprintf(cname1,"2022_PromptReco_new/plots/Numerator_vs_Denominator_2022_PromptReco_era%s_alpha%d.png",era,alphabin);
   sprintf(cname2,"2022_PromptReco_new/plots/Numerator_vs_Denominator_2022_PromptReco_era%s_alpha%d.pdf",era,alphabin);
   ...
   sprintf(cname1,"2022_PromptReco_new/plots/TriggerEfficiency_2022_PromptReco_era%s_alpha%d.png",era,alphabin);
   sprintf(cname2,"2022_PromptReco_new/plots/TriggerEfficiency_2022_PromptReco_era%s_alpha%d.pdf",era,alphabin);
   ...
   char foutname[1023];
   sprintf(foutname,"2022_PromptReco_new/rootfiles/TriggerEfficiency_2022_PromptReco_era%s_alpha%d.root",era,alphabin);
