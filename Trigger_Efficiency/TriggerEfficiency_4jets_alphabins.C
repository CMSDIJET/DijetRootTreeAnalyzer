...
{  
   ...
   char txtname[1024];
   //sprintf(txtname,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/textfiles/trig_Run%s_PromptReco_alpha%d.txt",era,alphabin);
   //sprintf(txtname,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/textfiles/trig_Run%s_PromptReco_alpha%d.txt",era,alphabin);
   sprintf(txtname,"Run3_PromptReco/JEC_LatestOfAug2023/textfiles/trig_Run%s_PromptReco_alpha%d.txt",era,alphabin);
   ...
   legend->AddEntry(h_Muon[1],"#splitline{PassMu50}{&& OR of triggers}","L");
   legend->AddEntry(h_Muon[0],"PassMu50","L");
   legend->Draw();


   char cname1[1024], cname2[1024];
   //sprintf(cname1,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.png",era,alphabin);
   //sprintf(cname2,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   //sprintf(cname1,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.png",era,alphabin);
   //sprintf(cname2,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   sprintf(cname1,"Run3_PromptReco/JEC_LatestOfAug2023/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.png",era,alphabin);
   sprintf(cname2,"Run3_PromptReco/JEC_LatestOfAug2023/plots/Numerator_vs_Denominator_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   ...
   //sprintf(cname1,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.png",era,alphabin);
   //sprintf(cname2,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   //sprintf(cname1,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.png",era,alphabin);
   //sprintf(cname2,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   sprintf(cname1,"Run3_PromptReco/JEC_LatestOfAug2023/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.png",era,alphabin);
   sprintf(cname2,"Run3_PromptReco/JEC_LatestOfAug2023/plots/TriggerEfficiency_Run%s_PromptReco_alpha%d.pdf",era,alphabin);
   ...
   char foutname[1023];
   //sprintf(foutname,"2022_PromptReco/JEC_Winter22Run3_RunCD_V2_DATA_and_Summer22EEPrompt22_RunFG_V1_DATA/rootfiles/TriggerEfficiency_Run%s_PromptReco_alpha%d.root",era,alphabin);
   //sprintf(foutname,"2023_PromptReco/JEC_Winter23Prompt23_RunC_V2_DATA/rootfiles/TriggerEfficiency_Run%s_PromptReco_alpha%d.root",era,alphabin);
   sprintf(foutname,"Run3_PromptReco/JEC_LatestOfAug2023/rootfiles/TriggerEfficiency_Run%s_PromptReco_alpha%d.root",era,alphabin);
