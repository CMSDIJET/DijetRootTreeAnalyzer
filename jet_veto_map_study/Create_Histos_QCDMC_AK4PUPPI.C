...
void Create_Histos_QCDMC_AK4PUPPI(){
...
double run, lumi, event, weight, nVtx, w;
...
//TFile *fout = new TFile("histos/Histos_AK4PUPPI_Run3Summer22EE_Stitched_QCD_PT-120to3200_NoVetoMap.root","RECREATE");
//TFile *fout = new TFile("histos/Histos_AK4PUPPI_Run3Summer22EE_Stitched_QCD_PT-120to3200_VetoMapEE.root","RECREATE");
TFile *fout = new TFile("histos/Histos_AK4PUPPI_Run3Summer22EE_Stitched_QCD_PT-120to3200_VetoMapAll.root","RECREATE");
fout->cd();
