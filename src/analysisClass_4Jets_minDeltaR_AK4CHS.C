...
void analysisClass::Loop()
{
   ...
   //for (Long64_t jentry=0; jentry<nentries;jentry=jentry+10) {   //takes every 10th en
	 ...
	 if(fabs(jetEtaAK4->at(sortedJetIdx[ijet])) < getPreCutValue1("jetFidRegion") && JetID->at(sortedJetIdx[ijet]) == getPreCutValue1("tightJetID") &&  (jecFactors[sortedJetIdx[ijet]]/jetJecAK4->at(sortedJetIdx[ijet]))*jetPtAK4->at(sortedJetIdx[ijet]) > getPreCutValue1("ptCut"))
	 {
	     Nak4 += 1;
	 ...
	 if(fabs(jetEtaAK4->at(sortedJetIdx[0])) < getPreCutValue1("jetFidRegion") && JetID->at(sortedJetIdx[0]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[0]]/jetJecAK4->at(sortedJetIdx[0]))*jetPtAK4->at(sortedJetIdx[0]) > getPreCutValue1("pt0Cut")){

	     if(fabs(jetEtaAK4->at(sortedJetIdx[1])) < getPreCutValue1("jetFidRegion") && JetID->at(sortedJetIdx[1]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[1]]/jetJecAK4->at(sortedJetIdx[1]))*jetPtAK4->at(sortedJetIdx[1]) > getPreCutValue1("pt1Cut")){

 		 if(fabs(jetEtaAK4->at(sortedJetIdx[2])) < getPreCutValue1("jetFidRegion") && JetID->at(sortedJetIdx[2]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[2]]/jetJecAK4->at(sortedJetIdx[2]))*jetPtAK4->at(sortedJetIdx[2]) > getPreCutValue1("pt2Cut")){

 		    if(fabs(jetEtaAK4->at(sortedJetIdx[3])) < getPreCutValue1("jetFidRegion") && JetID->at(sortedJetIdx[3]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[3]]/jetJecAK4->at(sortedJetIdx[3]))*jetPtAK4->at(sortedJetIdx[3]) > getPreCutValue1("pt3Cut")){
...
*/
     ...
     if( AK4jets.size() >=4 ){//4-jets analysis 
       ...
       fillVariableWithValue("IdTightAK4CHS_j1",JetID->at(sortedJetIdx[0]));
       ...
       fillVariableWithValue("IdTightAK4CHS_j2",JetID->at(sortedJetIdx[1]));
       ...
       fillVariableWithValue("IdTightAK4CHS_j3",JetID->at(sortedJetIdx[2]));
       ...
       fillVariableWithValue("IdTightAK4CHS_j4",JetID->at(sortedJetIdx[3]));
