...
*/
    ...
    std::string L1Path = "data/Run3Winter22_Flat2018QCD_MC/Run3Winter22_L1FastJet_AK4PFchs.txt";
...
void analysisClass::Loop()
{
   ...
   //for (Long64_t jentry=0; jentry<nentries;jentry=jentry+10) {   //takes every 10th en
     ...
     //count ak4 jets passing eta, pt threshold and id criteria
     int Nak4 = 0;
     double HTak4 = 0;
	 ...
	 if(fabs(jetEtaAK4->at(sortedJetIdx[ijet])) < getPreCutValue1("jetFidRegion") && idTAK4->at(sortedJetIdx[ijet]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[ijet]]/jetJecAK4->at(sortedJetIdx[ijet]))*jetPtAK4->at(sortedJetIdx[ijet]) > getPreCutValue1("ptCut"))
	 {
	     Nak4 += 1;
	 ...
	 if(fabs(jetEtaAK4->at(sortedJetIdx[0])) < getPreCutValue1("jetFidRegion") && idTAK4->at(sortedJetIdx[0]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[0]]/jetJecAK4->at(sortedJetIdx[0]))*jetPtAK4->at(sortedJetIdx[0]) > getPreCutValue1("pt0Cut")){

	     if(fabs(jetEtaAK4->at(sortedJetIdx[1])) < getPreCutValue1("jetFidRegion") && idTAK4->at(sortedJetIdx[1]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[1]]/jetJecAK4->at(sortedJetIdx[1]))*jetPtAK4->at(sortedJetIdx[1]) > getPreCutValue1("pt1Cut")){

 		 if(fabs(jetEtaAK4->at(sortedJetIdx[2])) < getPreCutValue1("jetFidRegion") && idTAK4->at(sortedJetIdx[2]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[2]]/jetJecAK4->at(sortedJetIdx[2]))*jetPtAK4->at(sortedJetIdx[2]) > getPreCutValue1("pt2Cut")){

 		    if(fabs(jetEtaAK4->at(sortedJetIdx[3])) < getPreCutValue1("jetFidRegion") && idTAK4->at(sortedJetIdx[3]) == getPreCutValue1("tightJetID") && (jecFactors[sortedJetIdx[3]]/jetJecAK4->at(sortedJetIdx[3]))*jetPtAK4->at(sortedJetIdx[3]) > getPreCutValue1("pt3Cut")){
...
*/
       ...
       DeltaRAK4_1_[comb][ijet]=ak4j1.DeltaR(b);//here DeltaR between jets of the 1st pair
       DeltaRAK4_2_[comb][ijet]=c.DeltaR(d);//here DeltaR between jets of the 2nd pair
       //cout<<DeltaRAK4_1_[comb][ijet]<<" "<<DeltaRAK4_2_[comb][ijet]<<endl; 
       DDR_[comb][ijet] = fabs(DeltaRAK4_1_[comb][ijet]-DeltaRAK4_2_[comb][ijet]);
       DeltaR_[comb][ijet] = fabs(DeltaRAK4_1_[comb][ijet]-0.8) + fabs(DeltaRAK4_2_[comb][ijet]-0.8);
...
*/
     ...
     fillVariableWithValue("Nak4chs",Nak4);
     fillVariableWithValue ("PassJSON", passJSON (runNo, lumi, isData));


     if( AK4jets.size() >=4 ){//4-jets analysis 

       fillVariableWithValue("IdTightAK4CHS_j1",idTAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("pTAK4CHS_j1", AK4jets[0].Pt());
       ...
       fillVariableWithValue("jetCSVAK4CHS_j1", jetCSVAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("jetHflavourAK4CHS_j1",hFlavourAK4->at(sortedJetIdx[0]));
       ...
       fillVariableWithValue("eleEnFractAK4CHS_j1", jetElfAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("muEnFractAK4CHS_j1", jetMufAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("neutrElectromFracAK4CHS_j1", jetNemfAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("chargedElectromFracAK4CHS_j1", jetCemfAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("chargedMultAK4CHS_j1", chMultAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("neutrMultAK4CHS_j1", neMultAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("photonMultAK4CHS_j1", phoMultAK4->at(sortedJetIdx[0]));
     
       fillVariableWithValue("IdTightAK4CHS_j2",idTAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("pTAK4CHS_j2", AK4jets[1].Pt() );
       fillVariableWithValue("etaAK4CHS_j2", AK4jets[1].Eta());
       fillVariableWithValue("phiAK4CHS_j2", AK4jets[1].Phi());
       fillVariableWithValue("jetJecAK4CHS_j2", jecFactors[sortedJetIdx[1]]); 
       fillVariableWithValue("jetJecUncAK4CHS_j2", jecUncertainty[sortedJetIdx[1]] );
       fillVariableWithValue("jetCSVAK4CHS_j2", jetCSVAK4->at(sortedJetIdx[1]) );
       fillVariableWithValue("jetHflavourAK4CHS_j2",hFlavourAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("neutrHadEnFracAK4CHS_j2", jetNhfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("chargedHadEnFracAK4CHS_j2", jetChfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("photonEnFracAK4CHS_j2", jetPhfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("eleEnFractAK4CHS_j2", jetElfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("muEnFractAK4CHS_j2", jetMufAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("neutrElectromFracAK4CHS_j2", jetNemfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("chargedElectromFracAK4CHS_j2", jetCemfAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("chargedMultAK4CHS_j2", chMultAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("neutrMultAK4CHS_j2", neMultAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("photonMultAK4CHS_j2", phoMultAK4->at(sortedJetIdx[1]));

       fillVariableWithValue("IdTightAK4CHS_j3",idTAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("pTAK4CHS_j3", AK4jets[2].Pt() );
       fillVariableWithValue("etaAK4CHS_j3", AK4jets[2].Eta());
       fillVariableWithValue("phiAK4CHS_j3", AK4jets[2].Phi());
       fillVariableWithValue("jetJecAK4CHS_j3", jecFactors[sortedJetIdx[2]]); 
       fillVariableWithValue("jetJecUncAK4CHS_j3", jecUncertainty[sortedJetIdx[2]] );
       fillVariableWithValue("jetCSVAK4CHS_j3", jetCSVAK4->at(sortedJetIdx[2]) );
       fillVariableWithValue("jetHflavourAK4CHS_j3",hFlavourAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("neutrHadEnFracAK4CHS_j3", jetNhfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("chargedHadEnFracAK4CHS_j3", jetChfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("photonEnFracAK4CHS_j3", jetPhfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("eleEnFractAK4CHS_j3", jetElfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("muEnFractAK4CHS_j3", jetMufAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("neutrElectromFracAK4CHS_j3", jetNemfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("chargedElectromFracAK4CHS_j3", jetCemfAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("chargedMultAK4CHS_j3", chMultAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("neutrMultAK4CHS_j3", neMultAK4->at(sortedJetIdx[2]));
       fillVariableWithValue("photonMultAK4CHS_j3", phoMultAK4->at(sortedJetIdx[2]));
            
       fillVariableWithValue("IdTightAK4CHS_j4",idTAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("pTAK4CHS_j4", AK4jets[3].Pt() );
       fillVariableWithValue("etaAK4CHS_j4", AK4jets[3].Eta());
       fillVariableWithValue("phiAK4CHS_j4", AK4jets[3].Phi());
       fillVariableWithValue("jetJecAK4CHS_j4", jecFactors[sortedJetIdx[3]]); 
       fillVariableWithValue("jetJecUncAK4CHS_j4", jecUncertainty[sortedJetIdx[3]] );
       fillVariableWithValue("jetCSVAK4CHS_j4", jetCSVAK4->at(sortedJetIdx[3]) );
       fillVariableWithValue("jetHflavourAK4CHS_j4",hFlavourAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("neutrHadEnFracAK4CHS_j4", jetNhfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("chargedHadEnFracAK4CHS_j4", jetChfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("photonEnFracAK4CHS_j4", jetPhfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("eleEnFractAK4CHS_j4", jetElfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("muEnFractAK4CHS_j4", jetMufAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("neutrElectromFracAK4CHS_j4", jetNemfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("chargedElectromFracAK4CHS_j4", jetCemfAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("chargedMultAK4CHS_j4", chMultAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("neutrMultAK4CHS_j4", neMultAK4->at(sortedJetIdx[3]));
       fillVariableWithValue("photonMultAK4CHS_j4", phoMultAK4->at(sortedJetIdx[3]));
      
       fillVariableWithValue("Dijet_MassAK4CHS_1", MJJAK4_1) ;
       fillVariableWithValue("Dijet_MassAK4CHS_2", MJJAK4_2) ;  
       fillVariableWithValue("FourjetMassAK4CHS", M4J_AK4) ; 
       fillVariableWithValue("MasymmetryAK4CHS" ,Masymmetry);
       fillVariableWithValue("MaverageAK4CHS", Maverage);
       fillVariableWithValue("DeltaEtaJJAK4CHS", DeltaEtaJJAK4);
       fillVariableWithValue("DeltaRAK4CHS_First",DeltaRAK4_First);
       fillVariableWithValue("DeltaRAK4CHS_Second",DeltaRAK4_Second);
       fillVariableWithValue("DeltaPhiJJAK4CHS",DeltaPhiJJAK4);
       fillVariableWithValue("ETA_AK4CHS_1",ETA_1);
       fillVariableWithValue("ETA_AK4CHS_2",ETA_2);
       fillVariableWithValue("RapidityAK4CHS_1",Rapidity_1);
       fillVariableWithValue("RapidityAK4CHS_2",Rapidity_2);
       fillVariableWithValue("DeltaRapidityAK4CHS",DeltaRapidity);
       fillVariableWithValue("PTAK4CHS_firstcomb_1",PT_firstcomb_1);
       fillVariableWithValue("PTAK4CHS_firstcomb_2",PT_firstcomb_2);
       fillVariableWithValue("PTAK4CHS_secondcomb_1",PT_secondcomb_1);
       fillVariableWithValue("PTAK4CHS_secondcomb_2",PT_secondcomb_2);
       fillVariableWithValue("DDR_AK4CHS",DDR);
       fillVariableWithValue("DeltaR_AK4CHS",DeltaR);
       fillVariableWithValue("DeltaAK4CHS_1", Delta_1);
       fillVariableWithValue("DeltaAK4CHS_2", Delta_2);
