...
void analysisClass::Loop()
{
  ...
  // variable binning for mjj trigger efficiency plots
   ...
   char* HLTname[50] = {"noTrig", "PFHT1050", "PFJet550", "Mu50", "AK8PFJet550", "CaloJet550", "AllJet"};
...
*/
	...
	if( triggerName->at(i).compare(0,24,"HLT_CaloJet550_NoJetID_v")==0 ) fillVariableWithValue("passHLT_CaloJet550_NoJetID",triggerResult->at(i));
	 ...
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass[6] -> Fill(M4J_AK8);
     }
	 ...
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha1[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha1[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha1[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha1[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha1[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha1[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha2)
     {
	 h_mjj_HLTpass_alpha2[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha2[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha2[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha2[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha2[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha2[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha2[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha3)
     {
	 h_mjj_HLTpass_alpha3[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha3[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha3[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha3[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha3[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha3[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha3[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha4)
     {
	 h_mjj_HLTpass_alpha4[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha4[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha4[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha4[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha4[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha4[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha4[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha5)
     {
	 h_mjj_HLTpass_alpha5[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha5[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha5[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha5[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha5[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha5[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha5[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha6)
     {
	 h_mjj_HLTpass_alpha6[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha6[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha6[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha6[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha6[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha6[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha6[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha7)
     {
	 h_mjj_HLTpass_alpha7[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha7[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha7[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha7[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha7[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha7[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha7[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha8)
     {
	 h_mjj_HLTpass_alpha8[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha8[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha8[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha8[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha8[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha8[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha8[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha9)
     {
	 h_mjj_HLTpass_alpha9[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha9[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha9[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha9[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha9[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha9[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha9[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha10)
     {
	 h_mjj_HLTpass_alpha10[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha10[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha10[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha10[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha10[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha10[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha10[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha11)
     {
	 h_mjj_HLTpass_alpha11[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha11[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha11[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha11[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha11[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha11[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha11[6] -> Fill(M4J_AK8);
     }
	 ...
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha12[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha12[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha12[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha12[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha12[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha12[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha13)
     {
	 h_mjj_HLTpass_alpha13[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1)           h_mjj_HLTpass_alpha13[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1)           h_mjj_HLTpass_alpha13[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               h_mjj_HLTpass_alpha13[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1) 	 h_mjj_HLTpass_alpha13[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1) h_mjj_HLTpass_alpha13[5] -> Fill(M4J_AK8);	

 	 if(getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)             h_mjj_HLTpass_alpha13[6] -> Fill(M4J_AK8);
     }
...
/*
     ...
     {
	 h_mjj_HLTpass[0] -> Fill(M4J_AK8); //noTrig
	 fillTriggerPlots(h_mjj_HLTpass,M4J_AK8);
     }
     ...
     {
	 h_mjj_HLTpass_alpha1[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha1,M4J_AK8);
     }

     if (fullAnalysis_alpha2)
     {
	 h_mjj_HLTpass_alpha2[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha2,M4J_AK8);
     }

     if (fullAnalysis_alpha3)
     {
	 h_mjj_HLTpass_alpha3[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha3,M4J_AK8);
     }

     if (fullAnalysis_alpha4)
     {
	 h_mjj_HLTpass_alpha4[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha4,M4J_AK8);
     }

     if (fullAnalysis_alpha5)
     {
	 h_mjj_HLTpass_alpha5[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha5,M4J_AK8);
     }

     if (fullAnalysis_alpha6)
     {
	 h_mjj_HLTpass_alpha6[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha6,M4J_AK8);
     }

     if (fullAnalysis_alpha7)
     {
	 h_mjj_HLTpass_alpha7[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha7,M4J_AK8);
     }

     if (fullAnalysis_alpha8)
     {
	 h_mjj_HLTpass_alpha8[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha8,M4J_AK8);
     }

     if (fullAnalysis_alpha9)
     {
	 h_mjj_HLTpass_alpha9[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha9,M4J_AK8);
     }

     if (fullAnalysis_alpha10)
     {
	 h_mjj_HLTpass_alpha10[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha10,M4J_AK8);
     }

     if (fullAnalysis_alpha11)
     {
	 h_mjj_HLTpass_alpha11[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha11,M4J_AK8);
     }

     if (fullAnalysis_alpha12)
     {
	 h_mjj_HLTpass_alpha12[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha12,M4J_AK8);
     }

     if (fullAnalysis_alpha13)
     {
	 h_mjj_HLTpass_alpha13[0] -> Fill(M4J_AK8); //noTrig
         fillTriggerPlots(h_mjj_HLTpass_alpha13,M4J_AK8);
     }
*/
...
/*
void analysisClass::fillTriggerPlots(TH1F* h[], double m4j) {

  bool pass_OR_of_triggers = false;

  for(unsigned int i=0; i<triggerName->size(); i++)
  {
	if ( triggerName->at(i).compare(0,14,"HLT_PFHT1050_v")==0 )
	{
		if(triggerResult->at(i)) {h[1] -> Fill(m4j);  pass_OR_of_triggers=true;}
	}

	if ( triggerName->at(i).compare(0,14,"HLT_PFJet550_v")==0 )
	{
		if(triggerResult->at(i)) {h[2] -> Fill(m4j);  pass_OR_of_triggers=true;}
	}

	if ( triggerName->at(i).compare(0,10,"HLT_Mu50_v")==0 )
	{
		if(triggerResult->at(i)) h[3] -> Fill(m4j);
	}	

	if ( triggerName->at(i).compare(0,17,"HLT_AK8PFJet550_v")==0 )
	{
		if(triggerResult->at(i)) {h[4] -> Fill(m4j);  pass_OR_of_triggers=true;}
	}

	if ( triggerName->at(i).compare(0,24,"HLT_CaloJet550_NoJetID_v")==0 )
	{
		if(triggerResult->at(i)) {h[5] -> Fill(m4j);  pass_OR_of_triggers=true;}
	}
  }

  if(pass_OR_of_triggers) h[6] -> Fill(m4j);
