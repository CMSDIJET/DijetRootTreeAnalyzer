...
*/
    ...
    std::string L2L3ResidualPath = "data/Prompt24-V6M/Prompt24_V6M/Prompt24_Run2024G_V6M_DATA_L2L3Residual_AK4PFPuppi.txt";
...
void analysisClass::Loop()
{
   ...
   //Define histos for trigger efficiency
  ...
  // variable binning for mjj trigger efficiency plots
   ...
   //inclusive in alpha (alpha>0.1)
   char name_histoHLT[50];
   TH1F* h_mjj_HLTpass[50]; 


   //13 alpha bins in 4jet analysis
   char name_histoHLT_alpha1[50];
   TH1F* h_mjj_HLTpass_alpha1[50];

   char name_histoHLT_alpha2[50];
   TH1F* h_mjj_HLTpass_alpha2[50];

   char name_histoHLT_alpha3[50];
   TH1F* h_mjj_HLTpass_alpha3[50];

   char name_histoHLT_alpha4[50];
   TH1F* h_mjj_HLTpass_alpha4[50];

   char name_histoHLT_alpha5[50];
   TH1F* h_mjj_HLTpass_alpha5[50];

   char name_histoHLT_alpha6[50];
   TH1F* h_mjj_HLTpass_alpha6[50];

   char name_histoHLT_alpha7[50];
   TH1F* h_mjj_HLTpass_alpha7[50];

   char name_histoHLT_alpha8[50];
   TH1F* h_mjj_HLTpass_alpha8[50];

   char name_histoHLT_alpha9[50];
   TH1F* h_mjj_HLTpass_alpha9[50];

   char name_histoHLT_alpha10[50];
   TH1F* h_mjj_HLTpass_alpha10[50];

   char name_histoHLT_alpha11[50];
   TH1F* h_mjj_HLTpass_alpha11[50];

   char name_histoHLT_alpha12[50];
   TH1F* h_mjj_HLTpass_alpha12[50];

   char name_histoHLT_alpha13[50];
   TH1F* h_mjj_HLTpass_alpha13[50];
  ...
  {  
     ...
     //13 alpha bins in 4jet analysis
     sprintf(name_histoHLT_alpha1,"h_mjj_HLTpass_alpha1_%s",HLTname[i]);
     h_mjj_HLTpass_alpha1[i]= new TH1F(name_histoHLT_alpha1,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha2,"h_mjj_HLTpass_alpha2_%s",HLTname[i]);
     h_mjj_HLTpass_alpha2[i]= new TH1F(name_histoHLT_alpha2,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha3,"h_mjj_HLTpass_alpha3_%s",HLTname[i]);
     h_mjj_HLTpass_alpha3[i]= new TH1F(name_histoHLT_alpha3,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha4,"h_mjj_HLTpass_alpha4_%s",HLTname[i]);
     h_mjj_HLTpass_alpha4[i]= new TH1F(name_histoHLT_alpha4,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha5,"h_mjj_HLTpass_alpha5_%s",HLTname[i]);
     h_mjj_HLTpass_alpha5[i]= new TH1F(name_histoHLT_alpha5,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha6,"h_mjj_HLTpass_alpha6_%s",HLTname[i]);
     h_mjj_HLTpass_alpha6[i]= new TH1F(name_histoHLT_alpha6,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha7,"h_mjj_HLTpass_alpha7_%s",HLTname[i]);
     h_mjj_HLTpass_alpha7[i]= new TH1F(name_histoHLT_alpha7,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha8,"h_mjj_HLTpass_alpha8_%s",HLTname[i]);
     h_mjj_HLTpass_alpha8[i]= new TH1F(name_histoHLT_alpha8,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha9,"h_mjj_HLTpass_alpha9_%s",HLTname[i]);
     h_mjj_HLTpass_alpha9[i]= new TH1F(name_histoHLT_alpha9,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha10,"h_mjj_HLTpass_alpha10_%s",HLTname[i]);
     h_mjj_HLTpass_alpha10[i]= new TH1F(name_histoHLT_alpha10,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha11,"h_mjj_HLTpass_alpha11_%s",HLTname[i]);
     h_mjj_HLTpass_alpha11[i]= new TH1F(name_histoHLT_alpha11,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha12,"h_mjj_HLTpass_alpha12_%s",HLTname[i]);
     h_mjj_HLTpass_alpha12[i]= new TH1F(name_histoHLT_alpha12,"",103,massBoundaries);

     sprintf(name_histoHLT_alpha13,"h_mjj_HLTpass_alpha13_%s",HLTname[i]);
     h_mjj_HLTpass_alpha13[i]= new TH1F(name_histoHLT_alpha13,"",103,massBoundaries);
   }
...
*/
     ...
     fillVariableWithValue("nJet",AK8jets.size());     
     ...
     if( AK8jets.size() >=4 ){//4-jets analysis 
      ...
      // fillVariableWithValue("jetCSVAK4PUPPI_j4", jetCSVAK8->at(sortedJetIdx[3]) );
       ...
       fillVariableWithValue("alphaAK4PUPPI", Maverage/M4J_AK8) ;
	...
	if( triggerName->at(i).compare(0,24,"HLT_CaloJet550_NoJetID_v")==0 ) fillVariableWithValue("passHLT_CaloJet550_NoJetID",triggerResult->at(i));
     ...
     bool fullAnalysis = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           && getVariableValue("pTAK4PUPPI_j1")  > getPreCutValue1("pTAK4PUPPI_j1_forTrig")
                           && getVariableValue("pTAK4PUPPI_j2")  > getPreCutValue1("pTAK4PUPPI_j2_forTrig") 
                           && getVariableValue("pTAK4PUPPI_j3")  > getPreCutValue1("pTAK4PUPPI_j3_forTrig")
                           && getVariableValue("pTAK4PUPPI_j4")  > getPreCutValue1("pTAK4PUPPI_j4_forTrig") 
                           && getVariableValue("etaAK4PUPPI_j1") > getPreCutValue1("etaAK4PUPPI_j1_forTrig")
                           && getVariableValue("etaAK4PUPPI_j1") < getPreCutValue2("etaAK4PUPPI_j1_forTrig")
                           && getVariableValue("etaAK4PUPPI_j2") > getPreCutValue1("etaAK4PUPPI_j2_forTrig")
                           && getVariableValue("etaAK4PUPPI_j2") < getPreCutValue2("etaAK4PUPPI_j2_forTrig")  
                           && getVariableValue("etaAK4PUPPI_j3") > getPreCutValue1("etaAK4PUPPI_j3_forTrig")
                           && getVariableValue("etaAK4PUPPI_j3") < getPreCutValue2("etaAK4PUPPI_j3_forTrig")   
                           && getVariableValue("etaAK4PUPPI_j4") > getPreCutValue1("etaAK4PUPPI_j4_forTrig")
                           && getVariableValue("etaAK4PUPPI_j4") < getPreCutValue2("etaAK4PUPPI_j4_forTrig")
                           && getVariableValue("DeltaEtaJJAK4PUPPI")    < getPreCutValue1("DetaJJforTrig")
                           && getVariableValue("MasymmetryAK4PUPPI")    < getPreCutValue1("MasymmetryforTrig")
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha_forTrig"));
        


     bool fullAnalysis_alpha1 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha1_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha1_forTrig"));

     bool fullAnalysis_alpha2 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha2_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha2_forTrig"));                 

     bool fullAnalysis_alpha3 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha3_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha3_forTrig"));

     bool fullAnalysis_alpha4 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha4_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha4_forTrig"));

     bool fullAnalysis_alpha5 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha5_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha5_forTrig"));

     bool fullAnalysis_alpha6 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha6_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha6_forTrig"));

     bool fullAnalysis_alpha7 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha7_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha7_forTrig"));

     bool fullAnalysis_alpha8 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha8_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha8_forTrig"));

     bool fullAnalysis_alpha9 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha9_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha9_forTrig"));

     bool fullAnalysis_alpha10 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha10_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha10_forTrig"));

     bool fullAnalysis_alpha11 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha11_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha11_forTrig"));

     bool fullAnalysis_alpha12 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha12_forTrig")
                           && getVariableValue("alphaAK4PUPPI")  	< getPreCutValue2("alpha12_forTrig"));

     bool fullAnalysis_alpha13 = ( passedCut("PassJSON")
			   && passedCut("nVtx") 
			   && passedCut("IdTightAK4PUPPI_j1")
			   && passedCut("IdTightAK4PUPPI_j2")
                           && passedCut("IdTightAK4PUPPI_j3")
			   && passedCut("IdTightAK4PUPPI_j4")
                           ...
                           && getVariableValue("DeltaRAK4PUPPI_First")  < getPreCutValue1("DeltaR1_forTrig")
                           && getVariableValue("DeltaRAK4PUPPI_Second") < getPreCutValue1("DeltaR2_forTrig")
			   && getVariableValue("alphaAK4PUPPI")  	> getPreCutValue1("alpha13_forTrig"));


     if (fullAnalysis)
     {
	 h_mjj_HLTpass[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass[6] -> Fill(M4J_AK8);
     }




     if (fullAnalysis_alpha1)
     {
	 h_mjj_HLTpass_alpha1[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha1[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha1[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha1[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha1[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha1[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha1[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha2)
     {
	 h_mjj_HLTpass_alpha2[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha2[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha2[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha2[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha2[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha2[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha2[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha3)
     {
	 h_mjj_HLTpass_alpha3[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha3[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha3[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha3[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha3[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha3[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha3[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha4)
     {
	 h_mjj_HLTpass_alpha4[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha4[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha4[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha4[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha4[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha4[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha4[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha5)
     {
	 h_mjj_HLTpass_alpha5[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha5[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha5[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha5[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha5[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha5[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha5[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha6)
     {
	 h_mjj_HLTpass_alpha6[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha6[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha6[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha6[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha6[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha6[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha6[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha7)
     {
	 h_mjj_HLTpass_alpha7[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha7[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha7[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha7[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha7[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha7[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha7[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha8)
     {
	 h_mjj_HLTpass_alpha8[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha8[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha8[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha8[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha8[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha8[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha8[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha9)
     {
	 h_mjj_HLTpass_alpha9[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha9[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha9[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha9[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha9[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha9[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha9[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha10)
     {
	 h_mjj_HLTpass_alpha10[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha10[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha10[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha10[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha10[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha10[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha10[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha11)
     {
	 h_mjj_HLTpass_alpha11[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha11[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha11[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha11[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha11[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha11[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha11[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha12)
     {
	 h_mjj_HLTpass_alpha12[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha12[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha12[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha12[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha12[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha12[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha12[6] -> Fill(M4J_AK8);
     }

     if (fullAnalysis_alpha13)
     {
	 h_mjj_HLTpass_alpha13[0] -> Fill(M4J_AK8); //noTrig
	 if(getVariableValue("passHLT_PFHT1050") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha13[1] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha13[2] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_Mu50") == 1)               					   h_mjj_HLTpass_alpha13[3] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_AK8PFJet550") == 1 && getVariableValue("passHLT_Mu50") == 1) 	   h_mjj_HLTpass_alpha13[4] -> Fill(M4J_AK8);
	 if(getVariableValue("passHLT_CaloJet550_NoJetID") == 1  && getVariableValue("passHLT_Mu50") == 1) h_mjj_HLTpass_alpha13[5] -> Fill(M4J_AK8);	

 	 if( (getVariableValue("passHLT_PFHT1050") == 1 || getVariableValue("passHLT_PFJet550") == 1 ||  getVariableValue("passHLT_AK8PFJet550") == 1 || getVariableValue("passHLT_CaloJet550_NoJetID") == 1)  && getVariableValue("passHLT_Mu50") == 1)            h_mjj_HLTpass_alpha13[6] -> Fill(M4J_AK8);
     }
   ...
   // write histos for trigger efficiency
   for (int i=0; i<7; i++)
   {  
     	h_mjj_HLTpass[i]->Write();
     	h_mjj_HLTpass_alpha1[i]->Write();
     	h_mjj_HLTpass_alpha2[i]->Write();
	h_mjj_HLTpass_alpha3[i]->Write();
	h_mjj_HLTpass_alpha4[i]->Write();
	h_mjj_HLTpass_alpha5[i]->Write();
	h_mjj_HLTpass_alpha6[i]->Write();
	h_mjj_HLTpass_alpha7[i]->Write();
	h_mjj_HLTpass_alpha8[i]->Write();
	h_mjj_HLTpass_alpha9[i]->Write();
	h_mjj_HLTpass_alpha10[i]->Write();
	h_mjj_HLTpass_alpha11[i]->Write();
	h_mjj_HLTpass_alpha12[i]->Write();
	h_mjj_HLTpass_alpha13[i]->Write();
   }
