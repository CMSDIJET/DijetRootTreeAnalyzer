...
//     std::string L2L3ResidualPath = "data/Run3Winter22_Flat2018QCD_MC/Run3Winter22_RunCD_V1_DATA_L2L3Residual_AK4PFPuppi.txt";
     std::string L2L3ResidualPath = "data/Run3Winter22_Flat2018QCD_MC/Winter22Run3_RunC_V2_DATA_L2Residual_AK4PFPuppi.txt"; //This is for when running runFG

    
    
    //uncertainty
   // unc = new JetCorrectionUncertainty("data/Spring16_V8_DATA/Spring16_25nsV8p2_DATA_Uncertainty_AK8PFchs.txt");
//unc = new JetCorrectionUncertainty("data/Fall17_17Nov2017_V6_MC/Fall17_17Nov2017_V6_MC_Uncertainty_AK8PFchs.txt");
    ...
    //uncertainty
   //unc = new JetCorrectionUncertainty("data/Fall17_17Nov2017_V6_DATA/RunB/Fall17_17Nov2017B_V6_DATA_Uncertainty_AK8PFchs.txt");
